...
def get_method(idx):
    ...
    proto_idx = struct.unpack_from('<H', dex, method_ids_off + idx * 8 + 2)[0]
...
for c_i in range(class_defs_size):
    ...
    if get_type(class_idx) == 'Lcom/netease/mpay/oversea/ui/g;':
        ...
        for _ in range(dm + vm):
            ...
            if code_off == 0x400144:
                print(f'0x400144 is method #{m_idx}: {get_method(m_idx)}')

# Find all callers of 0x400144 (method id)
target_method_idx = 27670 # we will see what m_idx is
